...
## [3.0.0] - Tool Decoupling & Architectural Evolution
...
## [2.0.0] - SPA Refactor & Documentation
...
- **Developer Documentation:** Created the `/docs` directory with `ROADMAP.md`, `PROGRESS.md` (now `CHANGELOG.md`), and `DEVELOPMENT_GUIDE.md`.
