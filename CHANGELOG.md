...
- **Documentation:** Updated `styling_guide.md` with CSS variables and implementation details for applying the new glassmorphism effect, ensuring visual consistency for standalone (iframed) tools.
